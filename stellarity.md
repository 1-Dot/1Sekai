...
### <img alt="Invicon Netherite Sword.png: Sprite image for Netherite Sword in Minecraft" src="https://koharasbasement.wiki.gg/images/8/81/Invicon_Netherite_Sword.png?58ae4b" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 暴击之刃 Critical Strike
...
使攻击有 `附魔等级 * 10%` 的几率造成双倍伤害。

### <img alt="Invicon Arrow of Slow Falling.png: Sprite image for Arrow of Slow Falling in Minecraft" src="https://koharasbasement.wiki.gg/images/a/a0/Invicon_Arrow_of_Slow_Falling.png?6d099b" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 漂浮之箭 Levitation Shot
...
使弓有 `[15 + 10 * (附魔等级 - 1)] / [100 + 12 (附魔等级 - 1)] * 100%` 的几率将箭矢变为悬浮之箭，对命中的目标施加悬浮效果。

效果的持续时间是随机的，并随等级提升。

- 最短时间为 4 秒。
- 最长时间为 7 秒。
  每一级都会使最短和最长持续时间增加 0.5 秒。

### <img alt="Invicon Elytra.png: Sprite image for Elytra in Minecraft" src="https://koharasbasement.wiki.gg/images/f/fd/Invicon_Elytra.png?48dfb8" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 装甲 Plated
...
增强鞘翅，使其提供 `1 + 附魔等级` 点护甲。

从等级 3 及以上开始，它还会提供 1 点盔甲韧性 (不受等级影响)。

每一级都会使飞行距离略微减少 `(1 + 附魔等级 * 3)%`。

### <img alt="Invicon Elytra.png: Sprite image for Elytra in Minecraft" src="https://koharasbasement.wiki.gg/images/f/fd/Invicon_Elytra.png?48dfb8" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 翱翔 Soaring
...
### <img alt="Invicon Netherite Sword.png: Sprite image for Netherite Sword in Minecraft" src="https://koharasbasement.wiki.gg/images/8/81/Invicon_Netherite_Sword.png?58ae4b" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 虚空之刃 Void Strike
...
使武器对被击中的生物施加 <img alt="EffectSprite voided.png: Sprite image for voided in Minecraft" src="https://koharasbasement.wiki.gg/images/8/8e/EffectSprite_voided.png?40e2e1" width="24" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> Voided I 效果，暂时将其最大生命值降低 20%。

### <img alt="Invicon Bow.png: Sprite image for Bow in Minecraft" src="https://koharasbasement.wiki.gg/images/6/62/Invicon_Bow.png?b6be7f" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 虚空之箭 Void Shot
...
使箭矢对被击中的生物施加 <img alt="EffectSprite voided.png: Sprite image for voided in Minecraft" src="https://koharasbasement.wiki.gg/images/8/8e/EffectSprite_voided.png?40e2e1" width="24" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> Voided I 效果，暂时将其最大生命值降低 20%。

### <img alt="Invicon Iron Sword.png: Sprite image for Iron Sword in Minecraft" src="https://koharasbasement.wiki.gg/images/5/50/Invicon_Iron_Sword.png?4d77b5" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 埋伏 Ambush
...
对没有主动攻击玩家的生物造成 `(100 + 50 * 附魔等级)%` 的伤害。

### <img alt="Invicon Gold Trim Leather Boots.png: Sprite image for Gold Trim Leather Boots in Minecraft" src="https://koharasbasement.wiki.gg/images/a/ab/Invicon_Gold_Trim_Leather_Boots.png?c6e60e" width="32" style="image-rendering: pixelated; display: inline-block; vertical-align: middle;"> 沙丘疾行 Dune Speed
...
可能与地牢与酒馆数据包的 [沙漠遗迹](/dnt.md#沙漠遗迹-desert-ruins) 冲突导致无法获取，暂未验证。
...
- [神圣之地 The Hallow](https://koharasbasement.wiki.gg/wiki/The_Hallow)

## 结构

- [末地城 End City](https://koharasbasement.wiki.gg/wiki/End_City)

## 生物

### 怪物

- [虚空僵尸 Voided Zombie](https://koharasbasement.wiki.gg/wiki/Voided_Zombie)

### Boss

- [光之女皇 Empress of Light](https://koharasbasement.wiki.gg/wiki/Empress_of_Light)
