...
> [!CAUTION] 基岩版支持
> 对以下在内、以及服务器其他地方的模组和数据包加入的新内容基本无法支持和显示，但你仍然可以游玩原版的大部分内容
...
- 除了四元素以外的所有画现在变成了猫 Meme，包括 1.21.7 新加入的的大电影画
...
将不死图腾在铁砧中命名为以下内容获得对应 fufu

也可以投稿继续加入你自己的内容，需要提供 Minecraft 资源包格式的贴图和模型 JSON
